const CACHE = 'coach-sandra-v27';
const ASSETS = [
  './coach_sandra.html',
  './sport_catalogue.js?v=24',
  './sport_v2_briques.js?v=24',
  './sport_v2_core.js?v=24',
  './sport_v2_seed.js?v=24',
  './sport_v2_saisie.js?v=24',
  './sport_v2_ui.js?v=24',
  './sport_v2_seance.js?v=24',
  './sport_v2_programme.js?v=24',
  './sport_v2_accueil.js?v=24',
  './manifest.json',
  './icon-192.png?v=2',
  './icon-512.png?v=2',
