const CACHE = 'coach-sandra-v23';
const ASSETS = [
  './coach_sandra.html',
  './sport_catalogue.js?v=20',
  './sport_v2_briques.js?v=20',
  './sport_v2_core.js?v=20',
  './sport_v2_seed.js?v=20',
  './sport_v2_saisie.js?v=20',
  './sport_v2_ui.js?v=20',
  './sport_v2_accueil.js?v=20',
  './manifest.json',
  './icon-192.png?v=2',
  './icon-512.png?v=2',
